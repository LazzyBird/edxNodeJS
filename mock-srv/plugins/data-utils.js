...
// import { promisify } from "node:util"; ---> Look to the next comment

// Promisify setTimeout  - chapter 3 mod and receiving server-side state in real-time update ******
...
// Mock - (or map, ****** revision of course can't decide) category to ID prefix
const catToPrefix = {
  electronics: "A",
  confectionery: "B",
};

/* Simulate realtime orders ---> look to the ***** comment
...
// Plugin - who knows. Nice "introduction to node - пливіть, сосиски"
